...
/**
 * 
 * Clase principal que contiene el menú del sistema de streaming.
 * 
 * Métodos que utiliza: Scanner, Catalogo y Pelicula.
 * 
...
public class Main {
    /**
     * 
     * Método principal que ejecuta la aplicación y el menú interactivo.
     * 
     * Métodos que utiliza: nextInt(), nextLine(), close() de Scanner; println(),
     * print() de System.out; agregarPelicula(), getPeliculas(),
     * buscarPeliculaPorTitulo() de Catalogo.
     * 
     * @author Ramiro Maldonado
     */
